...
int main()
{
	...
	pointLights[0] = PointLight(1.0f, 0.0f, 0.0f, // Color 
		0.0f, 1.0f, // Intensidad ambiental, intensidad difusa 
		-6.0f, 1.5f, 1.5f, // Vetor de posicion
		0.3f, 0.2f, 0.1f); //ecuacion de segundo grado (constante, lineal, exponencial)
	pointLightCount++;
	...
	spotLights[1] = SpotLight(0.0f, 1.0f, 0.0f, // Color
		...
		5.0f, 10.0f, 0.0f,  // Vetor de posicion
		0.0f, -5.0f, 0.0f, // Vector de direccion
		1.0f, 0.0f, 0.0f,  // Ecuacion: constante, lineal, exponencial
	...
	spotLights[2] = SpotLight(
		...
		0.0f, 0.6f, -3.0f,     // Posición inicial (se actualizará)
		1.0f, 0.0f, 0.0f,      // Dirección hacia X POSITIVO
		1.0f, 0.02f, 0.01f,    // Ecuación: constante, lineal, exponencial
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// ---------------------------------- LUZ DEL COCHE --------------------------------
		glm::vec3 carPosition = glm::vec3(0.0f + mainWindow.getmuevex(), 0.6f, -3.0f);

		// Faro derecho
		glm::vec3 carLightOffsetRight = glm::vec3(8.0f, 0.0f, 2.0f);
		spotLights[2].SetFlash(carPosition + carLightOffsetRight, glm::vec3(1.0f, 0.0f, 0.0f));

		// Faro izquierdo
		glm::vec3 carLightOffsetLeft = glm::vec3(8.0f, 0.0f, -2.0f);
		spotLights[3].SetFlash(carPosition + carLightOffsetLeft, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		// ------------------------------------------- Helicoptero ------------------------------------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 30.0f, 6.0));
		...
		// ----------------------------------------------- Antorcha --------------------------------------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-5.0f, 4.0f, 10.0));
