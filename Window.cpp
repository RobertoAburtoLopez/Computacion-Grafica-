...
Window::Window(GLint windowWidth, GLint windowHeight)
{
	...
	// Inicializar banderas de spotlights del coche en false
	spotlightAvanzar = false;
	spotlightRetroceder = false;
...
int Window::Initialise()
{
	...
	//CREAR VENTANA
	mainWindow = glfwCreateWindow(width, height, "Practica07:Iluminaci�n 1", NULL, NULL);
...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_Y && action == GLFW_PRESS)
	{
		...
		// Activar spotlight de retroceder (AZUL - direcci�n +X)
	...
	{
		theWindow->muevex -= 1.0;
		// Activar spotlight de avanzar (ROJO - direcci�n -X)
